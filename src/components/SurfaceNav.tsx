...
export default function SurfaceNav({ becoming, children, sticky = false }: Props) {
  return (
    ...
    >
      {/* Always a link now, and always to the root.
          It used to stop being one once there was a blueprint: the root was the
          quiz door, whose only offer is "begin your blueprint", so a returning
          person tapping the thing at the top of every screen was sent to be
          asked for something they had already given. The root is the front page
          now and it offers a returning person their Ledger, so there is
          something there for everyone and the special case is gone. */}
